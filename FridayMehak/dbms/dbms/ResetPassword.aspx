         ...
         <asp:Label ID="Label4" runat="server" Text="" ForeColor="Blue" ></asp:Label>
           ...
           <form id="frm2" runat="server">
              <%--<asp:Label ID="lblName" runat="server" Text="Name" Font-Bold="true"></asp:Label><br />
               ...
               <asp:Label ID="lblUserName" runat="server" Text="User Name" Font-Bold="true"></asp:Label><br />
               <asp:TextBox ID="txtUserName" runat="server" Width="400px"></asp:TextBox>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtUserName" Color="Red" runat="server" ErrorMessage="Enter name">Enter name</asp:RequiredFieldValidator>
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtPassword" Color="Red" runat="server" ErrorMessage="Enter Password"></asp:RequiredFieldValidator>
