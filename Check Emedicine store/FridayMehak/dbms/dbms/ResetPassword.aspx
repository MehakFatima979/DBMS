<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="dbms.ResetPassword" %>
         ...
         <asp:Label ID="Label4" runat="server" Text="" ForeColor="Blue" ></asp:Label>
           ...
           <form id="frm2" runat="server">
              <%--<asp:Label ID="lblName" runat="server" Text="Name" Font-Bold="true"></asp:Label><br />
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtUserName" Color="Red" runat="server" ErrorMessage="Enter email" ForeColor="#FF3300">Enter email</asp:RequiredFieldValidator>

               &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtUserName" ErrorMessage="wrong email format" ForeColor="#0066CC" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtPassword" Color="Red" runat="server" ErrorMessage="Enter Password" ForeColor="#FF3300"></asp:RequiredFieldValidator>
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtConfirmPwd"  Color="Red" runat="server" ErrorMessage="Enter Confirm Password" ForeColor="#FF3300"></asp:RequiredFieldValidator>

               <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPwd" ErrorMessage="Password doesn't match" ForeColor="#0066CC"></asp:CompareValidator>
...
<%--               </div>
             ...
             <%-- <asp:ScriptManager ID="ScriptManager1" runat="server">
               ...
               <asp:Button ID="cmdSignIn" runat="server" Text="Reset Password" BorderStyle="Groove" BackColor="RoyalBlue" OnClick="cmdSignIn_Click" Height="35px"  /><br /><br /><br />
