<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Staff_Report.aspx.cs" Inherits="dbms.Staff_Report" %>
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li class="treeview active menu-open">
          ...
          <ul class="treeview-menu">
            <li><a href="Staff_Report.aspx"><i class="fa fa-circle-o"></i> Staff Details</a></li>
    ...
    <section class="content-header">
      <h1>
       ...
       <%-- <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>--%>
         <li><button type="submit" class="btn btn-primary" onclick="Show_Click">Generate Pdf</button></li>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <%--<div class="form-group">
                    <asp:Table ID="Table1" runat="server" Height="100px" Width="1200px">
                        <asp:TableRow >
                                ...
                                <asp:TableCell ><b>Phone#</b></asp:TableCell>
                                 ...
                                 <asp:TableCell ><b>Gender</b></asp:TableCell>
                                    <asp:TableCell ><b>Salary</b></asp:TableCell>
                                     <asp:TableCell ><b>Pharmacy Name</b></asp:TableCell>
