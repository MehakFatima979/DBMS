<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adminpage.aspx.cs" Inherits="dbms.Adminpage" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <asp:TextBox ID="TextBox1" runat="server" Width="400px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Field is empty" ControlToValidate="TextBox1" ForeColor="#FF3300"></asp:RequiredFieldValidator>
             <br /><br />
      ...
      <asp:TextBox ID="TextBox2" runat="server" Width="400px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Field is empty" ControlToValidate="TextBox2" ForeColor="#FF3300"></asp:RequiredFieldValidator>
             <br /><br />
       <asp:Label ID="Label3" runat="server" Text="Location" Font-Bold="true"></asp:Label>
          ...
          <asp:TextBox ID="TextBox3" runat="server" Width="400px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Field is empty" ControlToValidate="TextBox3" ForeColor="#FF3300"></asp:RequiredFieldValidator>&nbsp;&nbsp;&nbsp;&nbsp; <br /><br />
              ...
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="ID">
                      <ItemTemplate>
                          ...
                          <asp:Label ID="lbl_ID" runat="server" Text='<%#Eval("PharmacyID") %>'></asp:Label>
                   ...
                   <asp:TemplateField HeaderText="Name">  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_Name" ErrorMessage="Enter name" ForeColor="#FF3300"></asp:RequiredFieldValidator> 
                    </EditItemTemplate>  
                </asp:TemplateField>  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_City" ErrorMessage="Enter City" ForeColor="#FF3300"></asp:RequiredFieldValidator> 
                    </EditItemTemplate>  
                </asp:TemplateField>  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_Location" ErrorMessage="Enter Location" ForeColor="#FF3300"></asp:RequiredFieldValidator> 
                    </EditItemTemplate>  
                </asp:TemplateField>  
