  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <asp:TextBox ID="txtName" runat="server" Width="400px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
             &nbsp;<br /><br />


       <asp:Label ID="lblComposition" runat="server" Text="Composition"  Font-Bold="true"></asp:Label><br />
      <asp:TextBox ID="txtComposition" runat="server" Width="400px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtComposition" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
             <br /><br />
       ...
       <asp:Label ID="lblDescription" runat="server" Text="Description" Font-Bold="true"></asp:Label><br />
          ...
          <asp:TextBox ID="txtCompany" runat="server" Width="400px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCompany" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
             <br /><br />

              <asp:Label ID="lblMedCode" runat="server" Text="Medicine Code" Font-Bold="true"></asp:Label>
             
             <br />
          <asp:TextBox ID="txtMedCode" runat="server" Width="400px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMedCode" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>&nbsp;&nbsp;&nbsp; <br /><br />


              <asp:Label ID="lblPurchasePrice" runat="server" Text="Purchase Price" Font-Bold="true"></asp:Label><br />
          <asp:TextBox ID="txtPurchasePrice" runat="server" Width="400px"></asp:TextBox>&nbsp;
             <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPurchasePrice" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
             &nbsp;&nbsp;
             <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtPurchasePrice" ErrorMessage="wrong format" ForeColor="#0066CC" ValidationExpression="(^([0-9]*|\d*\d{1}?\d*)$)"></asp:RegularExpressionValidator>
             <br /><br />


              <asp:Label ID="lblQuantity" runat="server" Text="Quantity" Font-Bold="true"></asp:Label><br />
          <asp:TextBox ID="txtQuantity" runat="server" Width="400px"></asp:TextBox>&nbsp;&nbsp;&nbsp;
             <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtQuantity" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
             &nbsp;
             <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtQuantity" ErrorMessage="wrong format" ForeColor="#0066CC" ValidationExpression="(^([0-9]*|\d*\d{1}?\d*)$)"></asp:RegularExpressionValidator>
             <br /><br />

             <asp:Label ID="lblAlertQty" runat="server" Text="Alert Quantity" Font-Bold="true"></asp:Label><br />
          <asp:TextBox ID="txtAlertQty" runat="server" Width="400px"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;
             <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtAlertQty" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
             &nbsp;&nbsp;&nbsp;
             <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtAlertQty" ErrorMessage="wrong format" ForeColor="#0066CC" ValidationExpression="(^([0-9]*|\d*\d{1}?\d*)$)"></asp:RegularExpressionValidator>
             <br /><br />

              <asp:Label ID="lblTax" runat="server" Text="Tax" Font-Bold="true"></asp:Label>
             
             <br />
          <asp:TextBox ID="txtTax" runat="server" Width="400px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtTax" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>&nbsp;&nbsp;&nbsp;&nbsp; <br /><br />
             ...
             <asp:Label ID="lblCreatedDate" runat="server" Text="Created Date" Font-Bold="true"  ></asp:Label><br />
               ...
               <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" Width="400px"></asp:TextBox> 
              <br />
             ...
             <asp:TextBox ID="TextBox2" runat="server" AutoPostBack="True" Width="400px"></asp:TextBox>
                <br />
             ...
             <asp:TextBox ID="TextBox3" runat="server" AutoPostBack="True" Width="400px"></asp:TextBox> 
               <br />
              ...
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="ID">
                   ...
                   <asp:TemplateField HeaderText="Medicine Name">  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txt_Name" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                    </EditItemTemplate>  
                </asp:TemplateField>  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txt_Name" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                    </EditItemTemplate>  
                </asp:TemplateField>  
                   ...
                   <asp:TemplateField HeaderText="Company">  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txt_Company" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                    </EditItemTemplate>  
                </asp:TemplateField>  
                   ...
                   <asp:TemplateField HeaderText="Med_Code">  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txt_Med_Code" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                    </EditItemTemplate>  
                </asp:TemplateField>  
                  ...
                  <asp:TemplateField HeaderText="Alert_Quantity">  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txt_Alert_Quantity" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                    </EditItemTemplate>  
                </asp:TemplateField>  
                   ...
                   <asp:TemplateField HeaderText="Quantity">  
                    ...
                    <EditItemTemplate>  
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="txt_Quantity" ErrorMessage="Field is empty" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                    </EditItemTemplate>  
                </asp:TemplateField>  
