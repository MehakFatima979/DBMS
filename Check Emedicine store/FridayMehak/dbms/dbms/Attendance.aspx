<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Attendance.aspx.cs" Inherits="dbms.Attendance" %>
         ...
         <asp:Label ID="Label4" runat="server" Text="" ForeColor="Blue" ></asp:Label>
           ...
           <form id="frm1" runat="server">
              <asp:Label ID="lblName" runat="server" Text="Name" Font-Bold="true"></asp:Label><br />
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Select Date" ForeColor="#FF3300" ControlToValidate="TextBox1"></asp:RequiredFieldValidator>
...
<%--               </div>
             ...
             <%-- <asp:ScriptManager ID="ScriptManager1" runat="server">
               ...
               <asp:Button ID="cmdSaveRecord" runat="server" Text="Save Record" BorderStyle="Groove" BackColor="RoyalBlue" OnClick="Button1_Click" Height="35px"  /><br /><br /><br />
