...
<head>
  ...
  <link rel="stylesheet"
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b><center>Pharmacist</center></b></span>
    </a>
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <%--<li class="treeview">
          ...
          <li><a href=""><i class="fa fa-book"></i> <span> Medicines</span></a></li>
          <li><a href=""><i class="fa fa-book"></i> <span> Search Medicines</span></a></li>
        ...
        <li class="treeview active menu-open">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> Profit & Loss</a></li>
              <li><a href=""><i class="fa fa-circle-o"></i> Daily Sold Medicines</a></li>
              <li><a href=""><i class="fa fa-circle-o"></i> Weekly Sold Medicines</a></li>
              <li><a href=""><i class="fa fa-circle-o"></i> Yearly Sold Medicines</a></li>
              <li><a href=""><i class="fa fa-circle-o"></i> Medicines Expiry Date</a></li>
              <li><a href=""><i class="fa fa-circle-o"></i> Remaining Medicines</a></li>
              <li><a href=""><i class="fa fa-circle-o"></i> Excessively Sold medicines on daily basis</a></li>
              <li><a href=""><i class="fa fa-circle-o"></i> Daily net amount of Sold Medicines</a></li>
