            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter adress">
                </div>
               ...
               <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter salary">
                </div>

                  <div class="form-group">
                  <label for="exampleInputEmail1">Pharmacy Name</label>
                  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Pharmacy Name">
                </div>
                    ...
                    <asp:Table ID="Table1" runat="server" Height="100px" Width="1000px">
                        <asp:TableRow >
                                ...
                                <asp:TableCell ><b>Password</b></asp:TableCell>
                                 <asp:TableCell ><b>Confirm Password</b></asp:TableCell>
