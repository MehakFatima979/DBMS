<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profit.aspx.cs" Inherits="WebApplication4.Profit" %>
                    ...
                    <asp:Table ID="Table2" runat="server" Height="100px" Width="1000px">
                        <asp:TableRow >
                                ...
                                <asp:TableCell ><b>Purchase Price</b></asp:TableCell>
                                  <asp:TableCell ><b>Sale Price</b></asp:TableCell>
                                <asp:TableCell ><b>Profit or Loss</b></asp:TableCell>
