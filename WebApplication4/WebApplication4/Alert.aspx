<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alert.aspx.cs" Inherits="WebApplication4.Alert" %>
        ...
        <li class="treeview active menu-open">
          ...
          <ul class="treeview-menu">
            <li><a href="Profit.aspx"><i class="fa fa-circle-o"></i> Profit or Loss</a></li>
               ...
               <li><a href="Medicines-Yearly.aspx"><i class="fa fa-circle-o"></i> Sold Medicines Yearly</a></li>
                ...
                <div class="form-group">
                    <asp:Table ID="Table2" runat="server" Height="100px" Width="1000px">
                        <asp:TableRow >
                               ...
                               <asp:TableCell ><b>Expiry Date</b></asp:TableCell>
